        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                <div className='flex justify-between flex-wrap gap-4 mt-4'>
                    ...
                    <button onClick={() => filterType('burger')} className='border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>Burgers</button>
                    ...
                    <button onClick={() => filterType('salad')} className='border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>Salad</button>
            ...
            <div>
                ...
                <div className='flex justify-between max-w-[390px] w-full gap-4 mt-4'>
